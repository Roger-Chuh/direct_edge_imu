...
public:
  ...
  EdgeAlignmentFactor(double x, double y, double z, Eigen::MatrixXf &map,
                      Eigen::MatrixXf &dx, Eigen::MatrixXf &dy, double fx,
                      double fy, double cx, double cy, int w, int h)

...
template <class ContainerAllocator> struct Odometry_ {
  typedef Odometry_<ContainerAllocator> Type;

  Odometry_() : curodom(), kfodom(), kfid(0), status(0) {}
  ...
  typedef boost::shared_ptr<::quadrotor_msgs::Odometry_<ContainerAllocator>>
      Ptr;
  typedef boost::shared_ptr<
      ::quadrotor_msgs::Odometry_<ContainerAllocator> const>
      ConstPtr;
...
operator<<(std::ostream &s,
           const ::quadrotor_msgs::Odometry_<ContainerAllocator> &v) {
  ros::message_operations::Printer<
      ::quadrotor_msgs::Odometry_<ContainerAllocator>>::stream(s, "", v);
  return s;
}
...
// {'nav_msgs': ['/opt/ros/indigo/share/nav_msgs/cmake/../msg'], 'std_msgs':
// ['/opt/ros/indigo/share/std_msgs/cmake/../msg'], 'quadrotor_msgs':
// ['/home/ygling2008/catkin_ws/src/quadrotor_msgs/msg'], 'geometry_msgs':
// ['/opt/ros/indigo/share/geometry_msgs/cmake/../msg'], 'actionlib_msgs':
// ['/opt/ros/indigo/share/actionlib_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsMessage<::quadrotor_msgs::Odometry_<ContainerAllocator>> : TrueType {};
...
template <class ContainerAllocator>
struct HasHeader<::quadrotor_msgs::Odometry_<ContainerAllocator>> : FalseType {
};
...
struct MD5Sum<::quadrotor_msgs::Odometry_<ContainerAllocator>> {
  static const char *value() { return "94d99f86002b25504a5d3354fa1ad709"; }

  static const char *
  value(const ::quadrotor_msgs::Odometry_<ContainerAllocator> &) {
    return value();
  }
...
struct DataType<::quadrotor_msgs::Odometry_<ContainerAllocator>> {
  static const char *value() { return "quadrotor_msgs/Odometry"; }
...
struct Printer<::quadrotor_msgs::Odometry_<ContainerAllocator>> {
  ...
  static void stream(Stream &s, const std::string &indent,
    ...
    s << indent << "curodom: ";
    s << std::endl;
    Printer<::nav_msgs::Odometry_<ContainerAllocator>>::stream(s, indent + "  ",
                                                               v.curodom);
    s << indent << "kfodom: ";
    s << std::endl;
    Printer<::nav_msgs::Odometry_<ContainerAllocator>>::stream(s, indent + "  ",

...
IGL_INLINE void slice_mask(const Eigen::PlainObjectBase<DerivedX> &X,
...
IGL_INLINE void slice_mask(const Eigen::PlainObjectBase<DerivedX> &X,
                           const Eigen::Array<bool, Eigen::Dynamic, 1> &R,
                           const int dim, Eigen::PlainObjectBase<DerivedX> &Y);

template <typename DerivedX>
IGL_INLINE Eigen::PlainObjectBase<DerivedX>
slice_mask(const Eigen::PlainObjectBase<DerivedX> &X,
           const Eigen::Array<bool, Eigen::Dynamic, 1> &R,
           const Eigen::Array<bool, Eigen::Dynamic, 1> &C);
template <typename DerivedX>
IGL_INLINE Eigen::PlainObjectBase<DerivedX>

...
//                                 Eigen::Dynamic> &V, const Eigen::Matrix<S,
//                                 Eigen::Dynamic, Eigen::Dynamic> &F,
//                                 Eigen::Matrix<T, Eigen::Dynamic,
//                                 Eigen::Dynamic> &NV, Eigen::Matrix<S,
//                                 Eigen::Dynamic, Eigen::Dynamic> &NF,
...
IGL_INLINE void igl::remove_duplicates(
    ...
    Eigen::PlainObjectBase<DerivedV> &NV, Eigen::PlainObjectBase<DerivedF> &NF,
...
template void igl::remove_duplicates<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::Matrix<Eigen::Matrix<int, -1, -1, 0, -1, -1>::Scalar, -1, 1, 0, -1,
                  1> &,
    double);
#endif

...
template <typename Q_type> static IGL_INLINE Q_type _QuatD(double w, double h) {
  using namespace std;
...
template <typename Q_type>
IGL_INLINE void
igl::trackball(const double w, const double h, const Q_type speed_factor,
               const double down_mouse_x, const double down_mouse_y,
               const double mouse_x, const double mouse_y, Q_type *quat) {
...
IGL_INLINE void
igl::trackball(const double w, const double h, const Q_type speed_factor,
               const Q_type *down_quat, const double down_mouse_x,
               const double down_mouse_y, const double mouse_x,
               const double mouse_y, Q_type *quat) {
  double qrot[4], qres[4], qorig[4];
  igl::trackball<double>(w, h, speed_factor, down_mouse_x, down_mouse_y,
                         mouse_x, mouse_y, qrot);
  double nqorig =
      sqrt(down_quat[0] * down_quat[0] + down_quat[1] * down_quat[1] +
           down_quat[2] * down_quat[2] + down_quat[3] * down_quat[3]);
...
IGL_INLINE void
igl::trackball(const double w, const double h, const double speed_factor,
  ...
  using namespace std;
  return trackball(w, h, (Scalarquat)speed_factor, down_quat.coeffs().data(),
...
template void igl::trackball<double>(double, double, double, double const *,
                                     double, double, double, double, double *);
// generated by autoexplicit.sh
template void igl::trackball<float>(double, double, float, float const *,
                                    double, double, double, double, float *);
template void igl::trackball<float, float>(double, double, double,
                                           Eigen::Quaternion<float, 0> const &,
                                           double, double, double, double,
                                           Eigen::Quaternion<float, 0> &);
template void igl::trackball<double, double>(
    double, double, double, Eigen::Quaternion<double, 0> const &, double,
    double, double, double, Eigen::Quaternion<double, 0> &);
#endif

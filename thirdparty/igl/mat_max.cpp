...
template <typename T>
IGL_INLINE void
igl::mat_max(const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> &X,
             const int dim, Eigen::Matrix<T, Eigen::Dynamic, 1> &Y,
...
template void
igl::mat_max<double>(Eigen::Matrix<double, -1, -1, 0, -1, -1> const &, int,

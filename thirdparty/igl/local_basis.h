...
namespace igl {
// Compute a local orthogonal reference system for each triangle in the given
// mesh Templates:
...
//   B2 eigen matrix #F by 3, each vector is tangent to the triangle and
//   perpendicular to B1 B3 eigen matrix #F by 3, normal of the triangle
//

...
// Inputs:
//   Ain  #V by #A eigen Matrix of mesh vertex attributes (each vertex has #A
//   attributes) F    #F by 3 eigne Matrix of face (triangle) indices
// Output:
//   Aout #V by #A eigen Matrix of mesh vertex attributes
template <typename DerivedV, typename DerivedF>
IGL_INLINE void
per_vertex_attribute_smoothing(const Eigen::PlainObjectBase<DerivedV> &Ain,

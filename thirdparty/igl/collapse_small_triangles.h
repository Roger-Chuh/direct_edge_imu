...
//   eps  epsilon for smallest allowed area treated as fraction of squared
//   bounding box
//     diagonal
// Outputs:
...
//
//
void collapse_small_triangles(const Eigen::MatrixXd &V,
                              const Eigen::MatrixXi &F, const double eps,
                              Eigen::MatrixXi &FF);
} // namespace igl

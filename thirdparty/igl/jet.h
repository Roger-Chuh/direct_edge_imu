...
//   g  green value
//   b  blue value
template <typename T> IGL_INLINE void jet(const T f, T *rgb);
template <typename T> IGL_INLINE void jet(const T f, T &r, T &g, T &b);
// Inputs:
//   Z  #Z list of factos
...
IGL_INLINE void jet(const Eigen::PlainObjectBase<DerivedZ> &Z,
                    const bool normalize, Eigen::PlainObjectBase<DerivedC> &C);
// Inputs:
//   min_z  value at blue
//   max_z  value at red
template <typename DerivedZ, typename DerivedC>

...
mosek_quadprog(const Index n,
               ...
               const std::vector<Scalar> &c, const Scalar cf, const Index m,
...
//
IGL_INLINE bool
mosek_quadprog(const Eigen::SparseMatrix<double> &Q, const Eigen::VectorXd &c,
               const double cf, const Eigen::SparseMatrix<double> &A,

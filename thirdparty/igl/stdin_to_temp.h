...
#include <cstdio>
namespace igl {
// Write stdin/piped input to a temporary file which can than be preprocessed as
// it is (a normal file). This is often useful if you want to process
// stdin/piped with library functions that expect to be able to fseek(),
// rewind() etc..
//

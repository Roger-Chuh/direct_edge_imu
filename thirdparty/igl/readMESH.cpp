...
#define LINE_MAX 2048
  ...
  if (0 != strcmp(str, "MeshVersionFormatted")) {
    fprintf(stderr, "Error: first word should be MeshVersionFormatted not %s\n",
            str);
    fclose(mesh_file);
    return false;
  }
  ...
  if (1 != fscanf(mesh_file, " %d", &number_of_vertices) ||
      number_of_vertices > 1000000000) {
  ...
  for (int i = 0; i < number_of_triangles; i++) {
    if (4 !=
        fscanf(mesh_file, " %d %d %d %d", &tri[0], &tri[1], &tri[2], &extra)) {
...
template bool igl::readMESH<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
...
// generated by autoexplicit.sh
template bool igl::readMESH<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
...
// generated by autoexplicit.sh
template bool igl::readMESH<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                            Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                            Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    std::basic_string<char, std::char_traits<char>, std::allocator<char>>,

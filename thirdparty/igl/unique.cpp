...
template <typename DerivedA, typename DerivedC, typename DerivedIA,
          typename DerivedIC>
IGL_INLINE void igl::unique(const Eigen::PlainObjectBase<DerivedA> &A,
...
template <typename DerivedA, typename DerivedIA, typename DerivedIC>
IGL_INLINE void igl::unique_rows(const Eigen::PlainObjectBase<DerivedA> &A,
                                 Eigen::PlainObjectBase<DerivedA> &C,
                                 Eigen::PlainObjectBase<DerivedIA> &IA,
                                 Eigen::PlainObjectBase<DerivedIC> &IC) {
  using namespace std;
...
template void igl::unique_rows<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void igl::unique_rows<Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                               Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                               Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
...
template void igl::unique<int>(std::vector<int, std::allocator<int>> const &,
                               std::vector<int, std::allocator<int>> &);
template void
igl::unique<long>(std::vector<long, std::allocator<long>> const &,

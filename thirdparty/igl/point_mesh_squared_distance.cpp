...
template <typename DerivedP, typename DerivedV, typename DerivedsqrD,
          typename DerivedI, typename DerivedC>
...
template void
igl::point_mesh_squared_distance<Eigen::Matrix<double, -1, -1, 0, -1, -1>,

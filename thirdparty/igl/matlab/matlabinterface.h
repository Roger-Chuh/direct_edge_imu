...
// PATH =
// /opt/local/bin:/opt/local/sbin:/Applications/MATLAB_R2011a.app/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/texbin:/usr/X11/bin
...
IGL_INLINE void mlsetmatrix(Engine **engine, std::string name,
...
// Receive a matrix from MATLAB
IGL_INLINE void
mlgetmatrix(Engine **mlengine, std::string name,
...
IGL_INLINE void mlsetmatrix(Engine **mlengine, std::string name,

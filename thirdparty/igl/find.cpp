...
IGL_INLINE void
igl::find(const Eigen::SparseMatrix<T> &X, Eigen::MatrixBase<DerivedI> &I,
...
template void igl::find<double, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
...
template void igl::find<double, Eigen::Matrix<double, -1, 1, 0, -1, 1>,
                        Eigen::Matrix<double, -1, 1, 0, -1, 1>,
                        Eigen::Matrix<double, -1, 1, 0, -1, 1>>(
    Eigen::SparseMatrix<double, 0, int> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &,

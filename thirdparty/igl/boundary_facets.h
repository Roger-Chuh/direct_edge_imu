...
// Input:
//  T  tetrahedron (triangle) index list, m by 4 (3), where m is the number of
//  tetrahedra
// Output:
//  F  list of boundary faces, n by 3 (2), where n is the number of boundary
//  faces
//
//
template <typename IntegerT, typename IntegerF>
IGL_INLINE void boundary_facets(const std::vector<std::vector<IntegerT>> &T,
...
IGL_INLINE void boundary_facets(const Eigen::PlainObjectBase<DerivedT> &T,

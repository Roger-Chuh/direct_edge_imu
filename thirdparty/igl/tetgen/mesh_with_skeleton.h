...
IGL_INLINE bool
mesh_with_skeleton(const Eigen::MatrixXd &V, const Eigen::MatrixXi &F,
                   ...
                   Eigen::MatrixXd &VV, Eigen::MatrixXi &TT,
                   Eigen::MatrixXi &FF);
...
mesh_with_skeleton(const Eigen::MatrixXd &V, const Eigen::MatrixXi &F,
                   const Eigen::MatrixXd &C, const Eigen::VectorXi & /*P*/,
                   const Eigen::MatrixXi &BE, const Eigen::MatrixXi &CE,
                   const int samples_per_bone, Eigen::MatrixXd &VV,
                   Eigen::MatrixXi &TT, Eigen::MatrixXi &FF);
} // namespace tetgen
} // namespace igl

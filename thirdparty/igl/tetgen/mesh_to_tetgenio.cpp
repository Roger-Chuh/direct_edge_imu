...
IGL_INLINE bool
igl::tetgen::mesh_to_tetgenio(const std::vector<std::vector<REAL>> &V,
...
IGL_INLINE bool
igl::tetgen::mesh_to_tetgenio(const Eigen::PlainObjectBase<DerivedV> &V,
...
template bool
igl::tetgen::mesh_to_tetgenio<Eigen::Matrix<double, -1, -1, 0, -1, -1>,

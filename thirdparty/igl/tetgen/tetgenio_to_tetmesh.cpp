...
IGL_INLINE bool igl::tetgen::tetgenio_to_tetmesh(
    const tetgenio &out, std::vector<std::vector<REAL>> &V,
    std::vector<std::vector<int>> &T, std::vector<std::vector<int>> &F) {
  using namespace std;
  // process points
...
IGL_INLINE bool
igl::tetgen::tetgenio_to_tetmesh(const tetgenio &out,
...
IGL_INLINE bool igl::tetgen::tetgenio_to_tetmesh(
    const tetgenio &out, Eigen::PlainObjectBase<DerivedV> &V,
    Eigen::PlainObjectBase<DerivedT> &T, Eigen::PlainObjectBase<DerivedF> &F) {
  using namespace igl;
  using namespace std;
...
template bool
igl::tetgen::tetgenio_to_tetmesh<Eigen::Matrix<double, -1, -1, 0, -1, -1>,

...
IGL_INLINE void igl::triangle_triangle_adjacency_extractTT(
    ...
    std::vector<std::vector<int>> &TTT, Eigen::PlainObjectBase<DerivedTT> &TT) {
...
template <typename Scalar, typename Index>
IGL_INLINE void
igl::triangle_triangle_adjacency(const Eigen::PlainObjectBase<Scalar> &V,
                                 const Eigen::PlainObjectBase<Index> &F,
...
IGL_INLINE void
igl::triangle_triangle_adjacency(const Eigen::PlainObjectBase<DerivedF> &F,
...
template <typename DerivedF, typename TTIndex, typename TTiIndex>
IGL_INLINE void igl::triangle_triangle_adjacency(
    const Eigen::PlainObjectBase<DerivedF> &F, const bool construct_TTi,
    std::vector<std::vector<std::vector<TTIndex>>> &TT,
    std::vector<std::vector<std::vector<TTiIndex>>> &TTi) {
...
template <typename DerivedE, typename DerivedEMAP, typename uE2EType,
          typename TTIndex, typename TTiIndex>
IGL_INLINE void igl::triangle_triangle_adjacency(
    const Eigen::PlainObjectBase<DerivedE> &E,
    const Eigen::PlainObjectBase<DerivedEMAP> &EMAP,
    const std::vector<std::vector<uE2EType>> &uE2E, const bool construct_TTi,
    std::vector<std::vector<std::vector<TTIndex>>> &TT,
    std::vector<std::vector<std::vector<TTiIndex>>> &TTi) {
  using namespace std;
  using namespace Eigen;
...
template void
igl::triangle_triangle_adjacency<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
...
template void
igl::triangle_triangle_adjacency<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
igl::triangle_triangle_adjacency<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> &);
template void
igl::triangle_triangle_adjacency<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                 Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                 Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
template void
igl::triangle_triangle_adjacency<Eigen::Matrix<int, -1, 2, 0, -1, 2>,

...
//
IGL_INLINE std::vector<int>
circulation(const int e, const bool ccw, const Eigen::MatrixXi &F,
...
IGL_INLINE void circulation(const int e, const bool ccw,
                            const Eigen::MatrixXi &F, const Eigen::MatrixXi &E,
                            const Eigen::VectorXi &EMAP,
                            const Eigen::MatrixXi &EF,
                            const Eigen::MatrixXi &EI, Eigen::VectorXi &vN);
} // namespace igl

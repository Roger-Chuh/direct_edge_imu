...
//   n  normal
IGL_INLINE void
pseudonormal_test(const Eigen::MatrixXd &V, const Eigen::MatrixXi &F,
                  const Eigen::MatrixXd &FN, const Eigen::MatrixXd &VN,
                  const Eigen::MatrixXd &EN, const Eigen::VectorXi &EMAP,
                  const Eigen::RowVector3d &q, const int i,
                  const Eigen::RowVector3d &c, double &s,
                  Eigen::RowVector3d &n);
IGL_INLINE void pseudonormal_test(const Eigen::MatrixXd &V,
                                  const Eigen::MatrixXi &E,
                                  const Eigen::MatrixXd &EN,
                                  const Eigen::MatrixXd &VN,
                                  const Eigen::RowVector2d &q, const int i,

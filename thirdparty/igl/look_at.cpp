...
template <typename Derivedeye, typename Derivedcenter, typename Derivedup,
          typename DerivedR>
IGL_INLINE void
igl::look_at(const Eigen::PlainObjectBase<Derivedeye> &eye,
...
template void igl::look_at<
    Eigen::Matrix<float, 3, 1, 0, 3, 1>, Eigen::Matrix<float, 3, 1, 0, 3, 1>,
    Eigen::Matrix<float, 3, 1, 0, 3, 1>, Eigen::Matrix<float, 4, 4, 0, 4, 4>>(

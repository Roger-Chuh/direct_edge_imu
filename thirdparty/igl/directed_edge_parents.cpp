...
IGL_INLINE void
igl::directed_edge_parents(const Eigen::PlainObjectBase<DerivedE> &E,
  ...
  for_each(roots.data(), roots.data() + roots.size(),
           [&](int r) { I(r) = -1; });
...
template void igl::directed_edge_parents<Eigen::Matrix<int, -1, -1, 0, -1, -1>,

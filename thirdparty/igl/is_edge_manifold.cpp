...
IGL_INLINE bool igl::is_edge_manifold(const Eigen::PlainObjectBase<DerivedF> &F,
...
IGL_INLINE bool
igl::is_edge_manifold(const Eigen::PlainObjectBase<DerivedV> & /*V*/,
...
template bool
igl::is_edge_manifold<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1>> const
        &);
// generated by autoexplicit.sh
// template bool igl::is_edge_manifold<double>(Eigen::Matrix<double, -1, -1, 0,
// -1, -1> const&, Eigen::Matrix<int, -1, -1, 0, -1, -1> const&);
template bool igl::is_edge_manifold<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                                    Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &);
template bool igl::is_edge_manifold<Eigen::Matrix<double, -1, 3, 0, -1, 3>,

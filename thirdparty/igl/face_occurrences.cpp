...
IGL_INLINE void
igl::face_occurrences(const std::vector<std::vector<IntegerF>> &F,
...
template void igl::face_occurrences<unsigned int, int>(
...
template void igl::face_occurrences<int, int>(

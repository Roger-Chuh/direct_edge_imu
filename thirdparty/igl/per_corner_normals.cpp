...
IGL_INLINE void
igl::per_corner_normals(const Eigen::PlainObjectBase<DerivedV> &V,
  ...
  for (size_t i = 0; int(i) < m; i++) {
    ...
    for (size_t j = 0; int(j) < n; j++) {
      ...
      for (int k = 0; k < (int)incident_faces.size(); k++) {
        Eigen::Matrix<typename DerivedV::Scalar, 3, 1> ifn =
            FN.row(incident_faces[k]);
...
template void igl::per_corner_normals<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
template void
igl::per_corner_normals<Eigen::Matrix<double, -1, 3, 1, -1, 3>,
...
template void igl::per_corner_normals<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    double, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> &);
template void igl::per_corner_normals<Eigen::Matrix<double, -1, 3, 0, -1, 3>,

...
IGL_INLINE void
igl::cotmatrix_entries(const Eigen::PlainObjectBase<DerivedV> &V,
  ...
  case 3: {
    ...
    C.resize(m, 3);
    for (int i = 0; i < m; i++) {
      C(i, 0) = (l(i, 1) * l(i, 1) + l(i, 2) * l(i, 2) - l(i, 0) * l(i, 0)) /
                dblA(i) / 4.0;
      C(i, 1) = (l(i, 2) * l(i, 2) + l(i, 0) * l(i, 0) - l(i, 1) * l(i, 1)) /
                dblA(i) / 4.0;
      C(i, 2) = (l(i, 0) * l(i, 0) + l(i, 1) * l(i, 1) - l(i, 2) * l(i, 2)) /
                dblA(i) / 4.0;
    }
    break;
  }

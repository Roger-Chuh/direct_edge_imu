...
IGL_INLINE void signed_distance(const Eigen::MatrixXd &P,
...
IGL_INLINE void signed_distance_pseudonormal(
    ...
    double &sqrd, int &i, Eigen::RowVector3d &c, Eigen::RowVector3d &n);
IGL_INLINE void signed_distance_pseudonormal(
    const AABB<Eigen::MatrixXd, 2> &tree, const Eigen::MatrixXd &V,
    const Eigen::MatrixXi &F, const Eigen::MatrixXd &FN,
    const Eigen::MatrixXd &VN, const Eigen::RowVector2d &q, double &s,
    double &sqrd, int &i, Eigen::RowVector2d &c, Eigen::RowVector2d &n);

...
IGL_INLINE bool
min_quad_with_fixed_solve(const min_quad_with_fixed_data<T> &data,
...
IGL_INLINE bool
min_quad_with_fixed(const Eigen::SparseMatrix<T> &A,
                    const Eigen::PlainObjectBase<DerivedB> &B,
                    const Eigen::PlainObjectBase<Derivedknown> &known,
                    const Eigen::PlainObjectBase<DerivedY> &Y,
...
template <typename T> struct igl::min_quad_with_fixed_data {

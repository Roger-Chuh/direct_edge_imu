...
template <typename DerivedX, typename DerivedE, typename DerivedN,
          typename DerivedB>
IGL_INLINE void igl::histc(const Eigen::PlainObjectBase<DerivedX> &X,
...
template void igl::histc<Eigen::Matrix<double, -1, 1, 0, -1, 1>,

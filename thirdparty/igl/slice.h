...
IGL_INLINE void slice(const Eigen::SparseMatrix<TX> &X,
...
IGL_INLINE void slice(const MatX &X, const Eigen::PlainObjectBase<DerivedR> &R,
                      const int dim, MatY &Y);
template <typename DerivedX, typename DerivedR, typename DerivedC,
          typename DerivedY>
IGL_INLINE void slice(const Eigen::PlainObjectBase<DerivedX> &X,
...
slice(const Eigen::PlainObjectBase<DerivedX> &X,
      const Eigen::Matrix<int, Eigen::Dynamic, 1> &R);
template <typename DerivedX>
IGL_INLINE Eigen::PlainObjectBase<DerivedX>
slice(const Eigen::PlainObjectBase<DerivedX> &X,

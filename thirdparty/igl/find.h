...
IGL_INLINE void
find(const Eigen::SparseMatrix<T> &X, Eigen::MatrixBase<DerivedI> &I,
     Eigen::MatrixBase<DerivedJ> &J, Eigen::MatrixBase<DerivedV> &V);
template <typename DerivedX, typename DerivedI, typename DerivedJ,
          typename DerivedV>
IGL_INLINE void find(const Eigen::PlainObjectBase<DerivedX> &X,
...
//   V  nnz vector of type T non-zeros entries in X
template <typename T>
IGL_INLINE void find(const Eigen::SparseVector<T> &X,

...
IGL_INLINE void deform_skeleton(
    ...
    const std::vector<Eigen::Affine3d,
                      Eigen::aligned_allocator<Eigen::Affine3d>> &vA,
    Eigen::MatrixXd &CT, Eigen::MatrixXi &BET);
// Inputs:
//   T  #BE*4 by 3 list of stacked transformation matrix
IGL_INLINE void deform_skeleton(const Eigen::MatrixXd &C,
                                const Eigen::MatrixXi &BE,
                                const Eigen::MatrixXd &T, Eigen::MatrixXd &CT,
                                Eigen::MatrixXi &BET);
} // namespace igl

...
IGL_INLINE void
igl::embree::ambient_occlusion(const igl::embree::EmbreeIntersector &ei,
...
template <typename DerivedV, typename DerivedF, typename DerivedP,
          typename DerivedN, typename DerivedS>
IGL_INLINE void
igl::embree::ambient_occlusion(const Eigen::PlainObjectBase<DerivedV> &V,
...
template void
igl::embree::ambient_occlusion<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<double, -1, 1, 0, -1, 1>>(
    igl::embree::EmbreeIntersector const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    int, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void
igl::embree::ambient_occlusion<Eigen::Matrix<double, 1, 3, 1, 1, 3>,
...
igl::embree::ambient_occlusion<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    int, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void
igl::embree::ambient_occlusion<Eigen::Matrix<double, -1, 3, 0, -1, 3>,

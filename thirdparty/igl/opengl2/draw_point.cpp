...
IGL_INLINE void igl::opengl2::draw_point(const double x, const double y,
                                         const double z,
...
IGL_INLINE void
igl::opengl2::draw_point(const Eigen::PlainObjectBase<DerivedP> &P,
                         const double requested_r, const bool selected) {
  switch (P.size()) {
  case 2:
...
template void igl::opengl2::draw_point<Eigen::Matrix<double, 3, 1, 0, 3, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 1, 0, 3, 1>> const &,
    double, bool);
template void igl::opengl2::draw_point<Eigen::Matrix<double, 2, 1, 0, 2, 1>>(

...
IGL_INLINE void
igl::opengl2::draw_skeleton_vector_graphics(const Eigen::MatrixXd &C,
...
IGL_INLINE void igl::opengl2::draw_skeleton_vector_graphics(
    ...
    const float *point_color, const float *line_color) {
...
IGL_INLINE void igl::opengl2::draw_skeleton_vector_graphics(
  ...
  return draw_skeleton_vector_graphics(C, BE, T, BBW_POINT_COLOR,
                                       BBW_LINE_COLOR);
}
...
IGL_INLINE void igl::opengl2::draw_skeleton_vector_graphics(
    const Eigen::PlainObjectBase<DerivedC> &C,
    const Eigen::PlainObjectBase<DerivedBE> &BE,
    const Eigen::PlainObjectBase<DerivedT> &T, const float *point_color,
...
template void igl::opengl2::draw_skeleton_vector_graphics<

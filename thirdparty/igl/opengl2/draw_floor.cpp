...
IGL_INLINE void igl::opengl2::draw_floor(const float *colorA,
                                         const float *colorB,
                                         const int GridSizeX,
                                         const int GridSizeY) {
  ...
  (old_color_material ? glEnable(GL_COLOR_MATERIAL)
...
IGL_INLINE void igl::opengl2::draw_floor_outline(const float *colorA,
                                                 const float *colorB,
                                                 const int GridSizeX,
                                                 const int GridSizeY) {
  const float SizeX = 0.5f * 100. / (double)GridSizeX;

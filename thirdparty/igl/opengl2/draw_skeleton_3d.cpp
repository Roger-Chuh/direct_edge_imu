...
IGL_INLINE void igl::opengl2::draw_skeleton_3d(
    ...
    const Eigen::PlainObjectBase<Derivedcolor> &color, const double half_bbd) {
...
template <typename DerivedC, typename DerivedBE, typename DerivedT>
IGL_INLINE void
igl::opengl2::draw_skeleton_3d(const Eigen::PlainObjectBase<DerivedC> &C,
                               const Eigen::PlainObjectBase<DerivedBE> &BE,
                               const Eigen::PlainObjectBase<DerivedT> &T) {
...
template void
igl::opengl2::draw_skeleton_3d<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
igl::opengl2::draw_skeleton_3d<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<float, 4, 1, 0, 4, 1>> const &,
    double);
template void
igl::opengl2::draw_skeleton_3d<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<int, -1, -1, 0, -1, -1>,

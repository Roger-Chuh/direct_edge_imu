...
template <typename DerivedV, typename DerivedF, typename DerivedFF,
          typename DerivedI>
void igl::opengl2::sort_triangles(const Eigen::PlainObjectBase<DerivedV> &V,
...
template void
igl::opengl2::sort_triangles<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void
igl::opengl2::sort_triangles_slow<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                                  Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                  Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                  Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,

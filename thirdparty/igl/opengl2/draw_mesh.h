...
IGL_INLINE void draw_mesh(const Eigen::MatrixXd &V, const Eigen::MatrixXi &F,
                          const Eigen::MatrixXd &N);

// Draw ../opengl/OpenGL_ commands needed to display a mesh with normals and
// per-vertex colors
//
// Inputs:
//   V  #V by 3 eigen Matrix of mesh vertex 3D positions
...
// Draw ../opengl/OpenGL_ commands needed to display a mesh with normals,
// per-vertex colors and LBS weights
//
// Inputs:
//   V  #V by 3 eigen Matrix of mesh vertex 3D positions
//   F  #F by 3|4 eigen Matrix of face (triangle/quad) indices

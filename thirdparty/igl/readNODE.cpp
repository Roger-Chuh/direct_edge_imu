...
#define LINE_MAX 2048
  ...
  if (num_attr) {
    fprintf(stderr,
            "readNODE: Error: %d attributes found in %s. "
            "Attributes are not supported...\n",
            num_attr, node_file_name.c_str());
    fclose(node_file);
    return false;
  }
...
template bool igl::readNODE<Eigen::Matrix<double, -1, -1, 0, -1, -1>,

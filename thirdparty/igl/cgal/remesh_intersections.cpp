...
template <typename DerivedV, typename DerivedF, typename Kernel,
          typename DerivedVV, typename DerivedFF, typename DerivedJ,
          typename DerivedIM>
IGL_INLINE void igl::cgal::remesh_intersections(
    const Eigen::PlainObjectBase<DerivedV> &V,
    const Eigen::PlainObjectBase<DerivedF> &F,
    const std::vector<CGAL::Triangle_3<Kernel>> &T,
    const std::map<typename DerivedF::Index,
    ...
    Eigen::PlainObjectBase<DerivedFF> &FF, Eigen::PlainObjectBase<DerivedJ> &J,
  ...
  vector<typename Eigen::Matrix<typename DerivedFF::Scalar, Dynamic, Dynamic>>
      NF(offending.size());
  ...
  for (const auto &okv : offending) {
    ...
    {
      Index i = 0;
      for (typename CDT_plus_2::Finite_vertices_iterator vit =
               cdt[o].finite_vertices_begin();
           vit != cdt[o].finite_vertices_end(); ++vit) {
        if (i < 3) {
          // cout<<T[f].vertex(i)<<
          ...
          for (int e = 0; e < 3 && !found; e++) {
            ...
            // loop over neighbors
            for (typename IndexList::const_iterator nit = facesij.begin();
                 nit != facesij.end() && !found; nit++) {
              // don't consider self
              if (*nit == f) {
                continue;
              }
              ...
              for (typename CDT_plus_2::Finite_vertices_iterator uit =
                       cdt[no].finite_vertices_begin();
                   uit != cdt[no].finite_vertices_end() && !found; ++uit) {
    ...
    }
    {
      ...
      for (typename CDT_plus_2::Finite_faces_iterator fit =
               cdt[o].finite_faces_begin();
           fit != cdt[o].finite_faces_end(); ++fit) {
  ...
  {
    Index i = 0;
    for (typename Point_3List::const_iterator nvit = NV.begin();
         nvit != NV.end(); nvit++) {
      for (Index d = 0; d < 3; d++) {
...
template void igl::cgal::remesh_intersections<
    Eigen::Matrix<double, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 3, 0, -1, 3>,
    CGAL::Epeck,
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    std::__1::vector<CGAL::Triangle_3<CGAL::Epeck>,
                     std::__1::allocator<CGAL::Triangle_3<CGAL::Epeck>>> const
        &,
    std::__1::map<
        Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
        std::__1::pair<
            Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
            std::__1::vector<CGAL::Object, std::__1::allocator<CGAL::Object>>>,
        std::__1::less<Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index>,
        std::__1::allocator<std::__1::pair<
            Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index const,
            std::__1::pair<
                Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
                std::__1::vector<CGAL::Object,
                                 std::__1::allocator<CGAL::Object>>>>>> const &,
    std::__1::map<
        std::__1::pair<Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
                       Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index>,
        std::__1::vector<
            Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
            std::__1::allocator<Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index>>,
        std::__1::less<
            std::__1::pair<Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
                           Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index>>,
        std::__1::allocator<std::__1::pair<
            std::__1::pair<Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
                           Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index> const,
            std::__1::vector<Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
                             std::__1::allocator<Eigen::Matrix<
                                 int, -1, 3, 0, -1, 3>::Index>>>>> const &,
...
template void igl::cgal::remesh_intersections<
    ...
    CGAL::Epeck,
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<long, -1, 1, 0, -1, 1>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    std::__1::vector<CGAL::Triangle_3<CGAL::Epeck>,
...
template void igl::cgal::remesh_intersections<
    Eigen::Matrix<double, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 3, 0, -1, 3>,
    CGAL::Epeck, Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
...
template void igl::cgal::remesh_intersections<
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    std::__1::vector<CGAL::Triangle_3<CGAL::Epick>,
                     std::__1::allocator<CGAL::Triangle_3<CGAL::Epick>>> const
        &,
    std::__1::map<
        Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index,
        std::__1::pair<
...
template void igl::cgal::remesh_intersections<
    Eigen::Matrix<double, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 3, 0, -1, 3>,
    CGAL::Epick, Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
...
template void igl::cgal::remesh_intersections<
    ...
    Eigen::Matrix<int, -1, -1, 0, -1, -1>, CGAL::Epeck,
    Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    std::__1::vector<CGAL::Triangle_3<CGAL::Epeck>,
        ...
        &,
    std::__1::map<
        Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index,
        std::__1::pair<
            Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index,
            std::__1::vector<CGAL::Object, std::__1::allocator<CGAL::Object>>>,
        std::__1::less<Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index>,
        std::__1::allocator<std::__1::pair<
            Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index const,
            std::__1::pair<
                Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index,
                std::__1::vector<CGAL::Object,
                                 std::__1::allocator<CGAL::Object>>>>>> const &,
    std::__1::map<
        std::__1::pair<Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index,
                       Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index>,
        std::__1::vector<
            Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index,
            std::__1::allocator<Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index>>,
        std::__1::less<
            std::__1::pair<Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index,
                           Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index>>,
        std::__1::allocator<std::__1::pair<
            std::__1::pair<Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index,
                           Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index> const,
            std::__1::vector<Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index,
                             std::__1::allocator<Eigen::Matrix<
                                 int, -1, -1, 0, -1, -1>::Index>>>>> const &,
...
template void igl::cgal::remesh_intersections<
    Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    Eigen::Matrix<int, -1, -1, 0, -1, -1>, CGAL::Epick,
    Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    Eigen::Matrix<int, -1, -1, 0, -1, -1>, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
...
template void igl::cgal::remesh_intersections<
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, CGAL::Epeck,
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<long, -1, 1, 0, -1, 1>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3,
                                         0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    std::__1::vector<CGAL::Triangle_3<CGAL::Epeck>,
                     std::__1::allocator<CGAL::Triangle_3<CGAL::Epeck>>> const
...
template void igl::cgal::remesh_intersections<
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, CGAL::Epick,
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<long, -1, 1, 0, -1, 1>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3,

...
template <typename DerivedV, typename DerivedF, typename DerivedN,
          typename DeriveduE, typename uE2EType, typename uE2oEType,
          typename uE2CType>
IGL_INLINE typename std::enable_if<
    !std::is_same<
        typename DerivedV::Scalar,
        typename CGAL::Exact_predicates_exact_constructions_kernel::FT>::value,
    void>::type
  ...
  for (size_t ui = 0; ui < num_undirected_edges; ui++) {
    ...
    if (degenerated) {
      if (edge_valance <= 2) {
        ...
        edge.setZero();
        Eigen::Matrix<typename DerivedN::Scalar, Eigen::Dynamic, 3> normals(
            edge_valance, 3);
        ...
        if (edge.norm() < EPS) {
          ...
          std::cerr << "Near zero edge surrounded by " << edge_valance
                    << " neearly colinear faces" << std::endl;
          std::cerr << "=====================================" << std::endl;
        }
      }
    } else {
...
igl::cgal::order_facets_around_edges(
  ...
  for (size_t ui = 0; ui < num_undirected_edges; ui++) {
    ...
    Vector3F edge(CGAL::to_double(exact_edge[0]),
...
template <typename DerivedV, typename DerivedF, typename DeriveduE,
          typename uE2EType, typename uE2oEType, typename uE2CType>
...
template void igl::cgal::order_facets_around_edges<
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 2, 0, -1, 2>,
    long, long, bool>(
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 2, 0, -1, 2>> const &,
    std::__1::vector<std::__1::vector<long, std::__1::allocator<long>>,
                     std::__1::allocator<std::__1::vector<
                         long, std::__1::allocator<long>>>> const &,
    std::__1::vector<
        std::__1::vector<long, std::__1::allocator<long>>,
        std::__1::allocator<std::__1::vector<long, std::__1::allocator<long>>>>
        &,
    std::__1::vector<
        std::__1::vector<bool, std::__1::allocator<bool>>,
        std::__1::allocator<std::__1::vector<bool, std::__1::allocator<bool>>>>
        &);
template void igl::cgal::order_facets_around_edges<
    Eigen::Matrix<double, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 2, 0, -1, 2>, long, long, bool>(
    ...
    std::__1::vector<
        ...
        &);
template void
igl::cgal::order_facets_around_edges<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                                     Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                     Eigen::Matrix<int, -1, 2, 0, -1, 2>, long,
                                     long, bool>(

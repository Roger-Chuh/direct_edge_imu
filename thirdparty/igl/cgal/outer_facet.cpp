...
template <typename DerivedV, typename DerivedF, typename DerivedI,
          typename IndexType>
IGL_INLINE void
igl::cgal::outer_facet(const Eigen::PlainObjectBase<DerivedV> &V,
                       const Eigen::PlainObjectBase<DerivedF> &F,
                       const Eigen::PlainObjectBase<DerivedI> &I, IndexType &f,
                       bool &flipped) {
  ...
  std::transform(incident_faces.data(),
                 ...
                 adj_faces.begin(), convert_to_signed_index);
...
template void igl::cgal::outer_facet<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    ...
    bool &);
template void igl::cgal::outer_facet<Eigen::Matrix<double, -1, -1, 0, -1, -1>,

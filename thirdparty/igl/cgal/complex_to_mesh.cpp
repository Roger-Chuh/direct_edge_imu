...
IGL_INLINE bool
igl::cgal::complex_to_mesh(const CGAL::Complex_2_in_triangulation_3<Tr> &c2t3,
        ...
        for (int ih = 0; ih < 3; ++ih) {
          ...
          if (face_status == C2t3::REGULAR) {
            ...
            if (oriented_set.find(fn) == oriented_set.end()) {
              if (oriented_set.find(c2t3.opposite_facet(fn)) ==
                  oriented_set.end()) {
...
template bool igl::cgal::complex_to_mesh<
    CGAL::Delaunay_triangulation_3<
        CGAL::Robust_circumcenter_traits_3<CGAL::Epick>,

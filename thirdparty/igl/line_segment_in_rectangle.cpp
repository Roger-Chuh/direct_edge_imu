...
IGL_INLINE bool igl::line_segment_in_rectangle(const Eigen::Vector2d &s,
  ...
  const auto SegmentIntersectRectangle =
      [](double a_rectangleMinX, double a_rectangleMinY, double a_rectangleMaxX,
  ...
  bool ret =
      SegmentIntersectRectangle(minX, minY, maxX, maxY, s(0), s(1), d(0), d(1));
  return ret;
}

...
//   enableOutput      (optional) enables the output (#iteration / hessian
//   correction / step size / positional constraints / barrier constraints /
//   deformation energy) (default : true) enableBarriers    (optional) enables
//   the non-flip constraints (default = true) enableAlphaUpdate (optional)
//   enables dynamic alpha weight adjustment (default = true) beta (optional)
//   steepness factor of barrier slopes (default: ARAP/LSCM = 0.01, Green = 1)
//   eps               (optional) smallest valid triangle area (default: 1e-5 *
//   smallest triangle)
//
// where:
//   v : # vertices
...
int lim(Eigen::Matrix<double, Eigen::Dynamic, 3> &vertices,

...
IGL_INLINE bool igl::write_triangle_mesh(
    const std::string str, const Eigen::PlainObjectBase<DerivedV> &V,
    const Eigen::PlainObjectBase<DerivedF> &F, const bool ascii) {
  using namespace std;
...
template bool igl::write_triangle_mesh<Eigen::Matrix<double, -1, -1, 0, -1, -1>,

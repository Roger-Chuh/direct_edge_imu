...
template <typename T> IGL_INLINE void igl::jet(const T x, T *rgb) {
  return jet(x, rgb[0], rgb[1], rgb[2]);
}

template <typename T> IGL_INLINE void igl::jet(const T x_in, T &r, T &g, T &b) {
...
IGL_INLINE void igl::jet(const Eigen::PlainObjectBase<DerivedZ> &Z,
...
template void igl::jet<Eigen::Matrix<double, -1, 1, 0, -1, 1>,
...
template void igl::jet<Eigen::Array<double, -1, 1, 0, -1, 1>,
                       Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
    Eigen::PlainObjectBase<Eigen::Array<double, -1, 1, 0, -1, 1>> const &, bool,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> &);
template void igl::jet<Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                       Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
...
template void igl::jet<Eigen::Matrix<float, -1, 1, 0, -1, 1>,
                       Eigen::Matrix<double, -1, -1, 0, -1, -1>>(

...
//
IGL_INLINE void create_mesh_vbo(const Eigen::MatrixXd &V,
                                const Eigen::MatrixXi &F, GLuint &V_vbo_id,
                                GLuint &F_vbo_id);
...
IGL_INLINE void create_mesh_vbo(const Eigen::MatrixXd &V,
                                ...
                                const Eigen::MatrixXd &N, GLuint &V_vbo_id,
                                GLuint &F_vbo_id, GLuint &N_vbo_id);
} // namespace opengl

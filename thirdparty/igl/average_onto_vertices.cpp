...
IGL_INLINE void igl::average_onto_vertices(
  ...
  SV = Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>::Zero(V.rows(),
                                                              S.cols());
  Eigen::Matrix<T, Eigen::Dynamic, 1> COUNT =
      Eigen::Matrix<T, Eigen::Dynamic, 1>::Zero(V.rows());
...
template void igl::average_onto_vertices<double, int>(

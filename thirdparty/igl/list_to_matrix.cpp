...
// generated by autoexplicit.sh
template bool igl::list_to_matrix<
    float, Eigen::PlainObjectBase<Eigen::Matrix<float, -1, 3, 1, -1, 3>>>(
...
// generated by autoexplicit.sh
template bool igl::list_to_matrix<
    double, Eigen::PlainObjectBase<Eigen::Matrix<float, -1, 3, 1, -1, 3>>>(
    std::vector<
...
// generated by autoexplicit.sh
template bool igl::list_to_matrix<
    double, Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>>>(
    std::vector<
        std::vector<double, std::allocator<double>>,
        std::allocator<std::vector<double, std::allocator<double>>>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
...
// generated by autoexplicit.sh
template bool
igl::list_to_matrix<double, Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    std::vector<
        std::vector<double, std::allocator<double>>,
        std::allocator<std::vector<double, std::allocator<double>>>> const &,
    Eigen::Matrix<int, -1, -1, 0, -1, -1> &);
...
template bool igl::list_to_matrix<
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
template bool
igl::list_to_matrix<int, Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
    std::vector<std::vector<int, std::allocator<int>>,
                std::allocator<std::vector<int, std::allocator<int>>>> const &,
    Eigen::Matrix<double, -1, -1, 0, -1, -1> &);
template bool
igl::list_to_matrix<int, Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
    ...
    Eigen::Matrix<double, -1, -1, 0, -1, -1> &);
template bool igl::list_to_matrix<
    double, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 1, -1, 3>>>(
    std::vector<
        std::vector<double, std::allocator<double>>,
        std::allocator<std::vector<double, std::allocator<double>>>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 1, -1, 3>> &);
template bool igl::list_to_matrix<
    double, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 2, 1, -1, 2>>>(
    std::vector<
        std::vector<double, std::allocator<double>>,
        std::allocator<std::vector<double, std::allocator<double>>>> const &,
...
template bool igl::list_to_matrix<
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template bool igl::list_to_matrix<
    double, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>>>(
    std::vector<
        std::vector<double, std::allocator<double>>,
        std::allocator<std::vector<double, std::allocator<double>>>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> &);
template bool igl::list_to_matrix<
    int, Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>>>(
    std::vector<std::vector<int, std::allocator<int>>,
                std::allocator<std::vector<int, std::allocator<int>>>> const &,
...
template bool igl::list_to_matrix<
    unsigned long, Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>>>(
    std::vector<unsigned long, std::allocator<unsigned long>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template bool igl::list_to_matrix<double, Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    std::vector<double, std::allocator<double>> const &,
    Eigen::Matrix<int, -1, 1, 0, -1, 1> &);
template bool igl::list_to_matrix<
    float, Eigen::PlainObjectBase<Eigen::Matrix<float, -1, -1, 0, -1, -1>>>(
    std::vector<std::vector<float, std::allocator<float>>,
                std::allocator<std::vector<float, std::allocator<float>>>> const
        &,
...
template bool igl::list_to_matrix<
    double, Eigen::PlainObjectBase<Eigen::Matrix<double, 2, 1, 0, 2, 1>>>(
    std::vector<double, std::allocator<double>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 2, 1, 0, 2, 1>> &);
template bool igl::list_to_matrix<
    double, Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 1, 0, 3, 1>>>(
    std::vector<double, std::allocator<double>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 1, 0, 3, 1>> &);
template bool igl::list_to_matrix<
    double, Eigen::PlainObjectBase<Eigen::Matrix<double, 4, 1, 0, 4, 1>>>(
    std::vector<double, std::allocator<double>> const &,
...
template bool igl::list_to_matrix<
    ...
    std::vector<unsigned long long int,
                std::allocator<unsigned long long int>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template bool igl::list_to_matrix<
    bool, Eigen::PlainObjectBase<Eigen::Array<bool, -1, 1, 0, -1, 1>>>(
    std::vector<bool, std::allocator<bool>> const &,

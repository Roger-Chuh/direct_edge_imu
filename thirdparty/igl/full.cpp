...
IGL_INLINE void igl::full(const Eigen::SparseMatrix<T> &A,
...
IGL_INLINE void igl::full(const Eigen::PlainObjectBase<DerivedA> &A,
                          Eigen::PlainObjectBase<DerivedB> &B) {
  assert(false && "Obsolete. Just call B = Matrix(A)");
  B = A;
}
...
template void igl::full<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                        Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> &);
// generated by autoexplicit.sh
template void igl::full<double, Eigen::Matrix<double, -1, -1, 0, -1, -1>>(

...
const char *const QPSolverNames[NUM_QP_SOLVERS] = {"QP_SOLVER_IGL_ACTIVE_SET",
                                                   "QP_SOLVER_MOSEK"};
...
IGL_INLINE bool bbw(const Eigen::PlainObjectBase<DerivedV> &V,
                    const Eigen::PlainObjectBase<DerivedEle> &Ele,
                    const Eigen::PlainObjectBase<Derivedb> &b,
                    const Eigen::PlainObjectBase<Derivedbc> &bc, BBWData &data,

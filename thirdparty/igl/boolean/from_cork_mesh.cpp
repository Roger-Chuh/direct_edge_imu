...
IGL_INLINE void
igl::boolean::from_cork_mesh(const CorkTriMesh &mesh,
...
template void
igl::boolean::from_cork_mesh<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                             Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    CorkTriMesh const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
template void
igl::boolean::from_cork_mesh<Eigen::Matrix<double, -1, 3, 0, -1, 3>,

...
template <typename DerivedVA, typename DerivedFA, typename DerivedVB,
          typename DerivedFB, typename DerivedVC, typename DerivedFC,
          typename DerivedJ, typename DerivedI>
IGL_INLINE void igl::boolean::mesh_boolean(
    const Eigen::PlainObjectBase<DerivedVA> &VA,
    const Eigen::PlainObjectBase<DerivedFA> &FA,
    const Eigen::PlainObjectBase<DerivedVB> &VB,
    const Eigen::PlainObjectBase<DerivedFB> &FB, const MeshBooleanType &type,
    ...
    Eigen::PlainObjectBase<DerivedFC> &FC, Eigen::PlainObjectBase<DerivedJ> &J,
  ...
  const auto &libigl_resolve = [](const MatrixX3S &V, const MatrixX3I &F,
                                  MatrixX3ES &CV, MatrixX3I &CF, VectorXJ &J,
                                  VectorXI &I) {
    MatrixX3ES SV;
    MatrixX3I SF;
    MatrixX2I SIF;
  ...
  const auto even = [&](const Index &f) -> bool { return (iter(f) % 2) == 0; };
  ...
  // Deal with duplicate faces
  {
    ...
    for (Index g = 0; g < gm; g++) {
      ...
      const bool consistent = (G(g, 0) == uG(ug, 0) && G(g, 1) == uG(ug, 1) &&
                               G(g, 2) == uG(ug, 2)) ||
                              (G(g, 0) == uG(ug, 1) && G(g, 1) == uG(ug, 2) &&
                               G(g, 2) == uG(ug, 0)) ||
                              (G(g, 0) == uG(ug, 2) && G(g, 1) == uG(ug, 0) &&
                               G(g, 2) == uG(ug, 1));
...
#ifdef IGL_MESH_BOOLEAN_DEBUG
        if (abs(ucounts(ug)) != 1) {
          cout << "count,ucount of " << counts(ug) << "," << ucounts(ug)
               << endl;
        }
#endif
        break;
...
template <typename DerivedVA, typename DerivedFA, typename DerivedVB,
          typename DerivedFB, typename DerivedVC, typename DerivedFC>
IGL_INLINE void
igl::boolean::mesh_boolean(const Eigen::PlainObjectBase<DerivedVA> &VA,
                           const Eigen::PlainObjectBase<DerivedFA> &FA,
                           const Eigen::PlainObjectBase<DerivedVB> &VB,
...
template void
igl::boolean::mesh_boolean<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    igl::boolean::MeshBooleanType const &,
...
template void igl::boolean::mesh_boolean<
    ...
    Eigen::Matrix<int, -1, -1, 0, -1, -1>,
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, -1, 0, -1, -1>, Eigen::Matrix<long, -1, 1, 0, -1, 1>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
...
template void igl::remove_unreferenced<
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
...
template unsigned long igl::cgal::peel_outer_hull_layers<
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
...
template void igl::cgal::outer_hull<
    Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 3, 0, -1, 3>,
    Eigen::Matrix<long, -1, 1, 0, -1, 1>, Eigen::Matrix<bool, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3,
                                         0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> &,
...
template void igl::barycenter<
    ...
    Eigen::PlainObjectBase<
        Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>> &);
#include <igl/mod.cpp>
template Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>>
igl::mod<Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> const &, int);
#include <igl/outer_element.cpp>
template void
igl::outer_edge<Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3, 0, -1, 3>,
                Eigen::Matrix<int, -1, 3, 0, -1, 3>,
                Eigen::Matrix<long, -1, 1, 0, -1, 1>, long,
                Eigen::Matrix<long, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<CGAL::Lazy_exact_nt<CGAL::Gmpq>, -1, 3,
                                         0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<long, -1, 1, 0, -1, 1>> const &,
    long &, long &,
    Eigen::PlainObjectBase<Eigen::Matrix<long, -1, 1, 0, -1, 1>> &);

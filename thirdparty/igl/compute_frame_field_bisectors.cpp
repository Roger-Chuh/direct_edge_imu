...
IGL_INLINE void
igl::compute_frame_field_bisectors(const Eigen::PlainObjectBase<DerivedV> &V,
...
template void
igl::compute_frame_field_bisectors<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> &);
template void
igl::compute_frame_field_bisectors<Eigen::Matrix<double, -1, -1, 0, -1, -1>,

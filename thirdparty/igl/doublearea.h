...
//
// Known bug: For dim==3 complexity is O(#V + #F)!! Not just O(#F). This is a
// big deal if you have 1million unreferenced vertices and 1 face
...
doublearea_single(const Eigen::PlainObjectBase<DerivedA> &A,
                  const Eigen::PlainObjectBase<DerivedB> &B,
                  const Eigen::PlainObjectBase<DerivedC> &C);

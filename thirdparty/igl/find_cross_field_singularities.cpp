...
IGL_INLINE void igl::find_cross_field_singularities(
    ...
    Eigen::PlainObjectBase<DerivedO> &isSingularity,
    Eigen::PlainObjectBase<DerivedO> &singularityIndex, bool isCombed) {
  // Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1> > Handle_MMatch;
  // Eigen::PlainObjectBase<Eigen::Matrix<int,  Eigen::Dynamic, 3> >
  // Handle_MMatch; Eigen::Matrix<int, Eigen::Dynamic, 3> Handle_MMatch;
  ...
  // Handle_MMatch;
  igl::cross_field_missmatch<DerivedV, DerivedF>(V, F, PD1, PD2, isCombed,
                                                 Handle_MMatch);
...
template void igl::find_cross_field_singularities<
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void
igl::find_cross_field_singularities<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
...
template void
igl::find_cross_field_singularities<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                                    Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                    Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(

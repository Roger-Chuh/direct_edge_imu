...
IGL_INLINE bool snap_to_canonical_view_quat(const Q_type *q,
                                            const Q_type threshold, Q_type *s);

template <typename Scalarq, typename Scalars>
IGL_INLINE bool snap_to_canonical_view_quat(const Eigen::Quaternion<Scalarq> &q,

...
IGL_INLINE void igl::adjacency_list(const Eigen::PlainObjectBase<Index> &F,
  ...
  if (sorted) {
    ...
    // for every vertex v store a set of ordered edges not incident to v that
    // belongs to triangle incident on v.
...
template void igl::adjacency_list<Eigen::Matrix<int, -1, -1, 0, -1, -1>, int>(
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    std::vector<std::vector<int, std::allocator<int>>,
                std::allocator<std::vector<int, std::allocator<int>>>> &,
    bool);
template void igl::adjacency_list<Eigen::Matrix<int, -1, 3, 0, -1, 3>, int>(

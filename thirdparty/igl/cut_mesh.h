...
//   VFi               #V list of lists of index of incidence within incident
//   faces listed
...
//   Vcut             #V by 3 list of the vertex positions of the cut mesh. This
//   matrix will be
//                    similar to the original vertices except some rows will be
//                    duplicated.
//   Fcut             #F by 3 list of the faces of the cut mesh(must be
//   triangles). This matrix
//                    will be similar to the original face matrix except some
//                    indices will be redirected to point to the newly
//                    duplicated vertices.
//

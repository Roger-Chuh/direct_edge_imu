...
template <typename T> IGL_INLINE int igl::min_size(const std::vector<T> &V) {
  int min_size = -1;
...
template int
igl::min_size<std::vector<unsigned int, std::allocator<unsigned int>>>(
...
// generated by autoexplicit.sh
template int igl::min_size<std::vector<int, std::allocator<int>>>(
    std::vector<std::vector<int, std::allocator<int>>,
                std::allocator<std::vector<int, std::allocator<int>>>> const &);
// generated by autoexplicit.sh
template int igl::min_size<std::vector<double, std::allocator<double>>>(
    std::vector<
        std::vector<double, std::allocator<double>>,
        std::allocator<std::vector<double, std::allocator<double>>>> const &);
template int igl::min_size<std::vector<bool, std::allocator<bool>>>(
    std::vector<std::vector<bool, std::allocator<bool>>,
                std::allocator<std::vector<bool, std::allocator<bool>>>> const
        &);
template int igl::min_size<std::vector<float, std::allocator<float>>>(

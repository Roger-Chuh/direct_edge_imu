...
IGL_INLINE void igl::slice_into(const Eigen::PlainObjectBase<DerivedX> &X,
                                const Eigen::Matrix<int, Eigen::Dynamic, 1> &R,
                                const Eigen::Matrix<int, Eigen::Dynamic, 1> &C,
...
IGL_INLINE void igl::slice_into(const Mat &X,
                                const Eigen::Matrix<int, Eigen::Dynamic, 1> &R,
                                const int dim, Mat &Y) {
  Eigen::VectorXi C;
  switch (dim) {
...
template void igl::slice_into<Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
...
template void igl::slice_into<Eigen::Matrix<double, -1, 1, 0, -1, 1>>(
    ...
    Eigen::Matrix<int, -1, 1, 0, -1, 1> const &, int,
    Eigen::Matrix<double, -1, 1, 0, -1, 1> &);
template void igl::slice_into<Eigen::SparseMatrix<double, 0, int>>(
...
template void
igl::slice_into<Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>>>(
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> const &,
    Eigen::Matrix<int, -1, 1, 0, -1, 1> const &, int,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
#endif

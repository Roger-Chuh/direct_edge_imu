...
template <typename DerivedV, typename DerivedF, typename DerivedFN,
          typename DerivedN, typename DerivedE, typename DerivedEMAP>
IGL_INLINE void
igl::per_edge_normals(const Eigen::PlainObjectBase<DerivedV> &V,
...
template <typename DerivedV, typename DerivedF, typename DerivedN,
          typename DerivedE, typename DerivedEMAP>
IGL_INLINE void
igl::per_edge_normals(const Eigen::PlainObjectBase<DerivedV> &V,
                      const Eigen::PlainObjectBase<DerivedF> &F,
                      const PerEdgeNormalsWeightingType weighting,
...
igl::per_edge_normals(const Eigen::PlainObjectBase<DerivedV> &V,
                      ...
                      Eigen::PlainObjectBase<DerivedE> &E,
                      Eigen::PlainObjectBase<DerivedEMAP> &EMAP) {
  return per_edge_normals(V, F, PER_EDGE_NORMALS_WEIGHTING_TYPE_DEFAULT, N, E,
                          EMAP);
}

#ifdef IGL_STATIC_LIBRARY
// Explicit template specialization
template void igl::per_edge_normals<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
template void igl::per_edge_normals<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    igl::PerEdgeNormalsWeightingType,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);

...
namespace igl {
// Computes principal matchings of the vectors of a frame field across face
// edges, and generates a combed frame field defined on the mesh faces. This
// makes use of a combed cross field generated by combing the field created by
// the bisectors of the frame field.
...
//   BIS2_combed  #F by 3 eigen Matrix of the second combed bisector field
//   vector
// Output:
...
IGL_INLINE void
comb_frame_field(const Eigen::PlainObjectBase<DerivedV> &V,
